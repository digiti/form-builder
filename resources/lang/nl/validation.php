...
return [
    ...
    "between.array" => "Dit veld moet tussen :min en :max items bevatten.",
    "between.file" => "Dit veld moet tussen :min en :max kilobytes zijn.",
    ...
    "gt.array" => "De inhoud moet meer dan :value waardes bevatten.",
    "gt.file" => "Het bestand moet groter zijn dan :value kilobytes.",
    "gt.numeric" => "De waarde moet groter zijn dan :value.",
    "gt.string" => "De waarde moet meer dan :value tekens bevatten.",
    "gte.array" => "De inhoud moet :value waardes of meer bevatten.",
    "gte.file" => "Het bestand moet groter of gelijk zijn aan :value kilobytes.",
    "gte.numeric" => "De waarde moet groter of gelijk zijn aan :value.",
    "gte.string" => "De waarde moet minimaal :value tekens bevatten.",
    ...
    "lt.array" => "De inhoud moet minder dan :value waardes bevatten.",
    "lt.file" => "Het bestand moet kleiner zijn dan :value kilobytes.",
    "lt.numeric" => "De waarde moet kleiner zijn dan :value.",
    "lt.string" => "De waarde moet minder dan :value tekens bevatten.",
    "lte.array" => "De inhoud moet :value waardes of minder bevatten.",
    "lte.file" => "Het bestand moet kleiner of gelijk zijn aan :value kilobytes.",
    "lte.numeric" => "De waarde moet kleiner of gelijk zijn aan :value.",
    "lte.string" => "De waarde moet maximaal :value tekens bevatten.",
    "mac_address" => "De waarde moet een geldig MAC-adres zijn.",
    "max.array" => "De inhoud mag niet meer dan :max items bevatten.",
    "max.file" => "Het bestand mag niet meer dan :max kilobytes zijn.",
    "max.numeric" => "De waarde mag niet hoger dan :max zijn.",
    "max.string" => "De waarde mag niet uit meer dan :max tekens bestaan.",
    ...
    "min.array" => "De inhoud moet minimaal :min items bevatten.",
    "min.file" => "Het bestand moet minimaal :min kilobytes zijn.",
    "min.numeric" => "De waarde moet minimaal :min zijn.",
    "min.string" => "De waarde moet minimaal :min tekens zijn.",
    ...
    "password.letters" => "Dit veld moet minimaal één letter bevatten.",
    "password.mixed" => "Dit veld moet minimaal één kleine letter en één hoofdletter bevatten.",
    "password.numbers" => "Dit veld moet minimaal één cijfer bevatten.",
    "password.symbols" => "Dit veld moet minimaal één vreemd teken bevatten.",
    "password.uncompromised" => "De opgegeven waarde komt voor in een datalek. Kies een ander waarde.",
    ...
    "size.array" => "De inhoud moet :size items bevatten.",
    "size.file" => "Het bestand moet :size kilobyte zijn.",
    "size.numeric" => "De waarde moet :size zijn.",
    "size.string" => "De waarde moet :size tekens zijn.",
